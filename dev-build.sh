#!/usr/bin/env bash
# dev-build.sh — build and install Rubric locally for testing
#
...
echo "==> Building Rubric $VERSION (local dev install)"
...
echo ""
echo "Done! Rubric $VERSION is installed locally."
echo "Run it with: flatpak run io.github.calstfrancis.rubric"
