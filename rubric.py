...
class MainWindow(Adw.ApplicationWindow):
    ...
    def _build_ui(self):
        ...
        self._preview_btn.connect("clicked", self._preview._toggle_preview_panel)
        ...
        self._main_stack.add_named(self._preamble._build_preamble_panel(), "preamble")

        # Inner paned: order/preamble stack | bulletin preview (preview hidden by default)
        self._preview_panel = self._preview._build_preview_panel()
